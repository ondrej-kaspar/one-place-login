...
<html lang="en">
<head>
<?= renderHead(['title' => 'Link expired']); ?></head>
<body>
...
<div class="login">
  ...
  <div class="login__body">
    <div class="grid gap-6 max-w-[440px] mx-auto">
      ...
      <h2 class="heading-md text-center">Platnost odkazu vypršela</h2>
      <div class="grid gap-4">
        <p class="text-text-secondary text-center body-md">Pro email <strong>michal.klimt@almamedia.com</strong> platnost odkazu vypršela. Chcete si email s přihlašovacím linkem odeslat znovu?.</p>
        <div>
